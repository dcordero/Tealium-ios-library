...
//// Init option values - these supercede any remote settings.
//// The TLPauseInit option has been deprecated.  Use the globalCustomData argument in the initShared instance call to add data prior to the first track call
